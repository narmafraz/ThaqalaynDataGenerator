...
Saves to benchmark/phase1_qwen_round_b/. Reuses the 30-verse sample.
"""
...
logger = logging.getLogger("phase1_qwen_round_b")

BENCH_DIR = REPO_ROOT / "benchmark" / "phase1_qwen_round_b"
...
async def main_async() -> None:
    ...
    logger.info("ROUND B (few-shot): %d verses, strict json_schema, workers=%d",
                len(verses), WORKERS)
