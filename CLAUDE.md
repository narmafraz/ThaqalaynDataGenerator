...
1. **Generate (Pass 1)** — `ai-generate` agent (Opus): Extracts verse data, builds prompt, generates all 13 fields, validates schema. For long hadiths (>80 words), uses chunked processing.
